...
public class HexGridChunk : MonoBehaviour
{
    ...
    {
        TriangulateEdgeFan(center, e, cell.TerrainTypeIndex, cell.Index);
    ...
    )
    {
        ...
        TriangulateEdgeFan(center, m, cell.TerrainTypeIndex, cell.Index);
        //todo 新加的添加场景模型方法
        if (!cell.IsUnderwater && !cell.HasRoadThroughEdge(direction))
        {
            features.AddFeature(cell, (center + e.v1 + e.v5) * (1f / 3f));
    ...
    )
    {
        ...
        else
        {
            TriangulateEdgeStrip(
                ...
                e2, weights1, neighbor.Index, hasRoad
            );
        }
    ...
    /// 绘制边界的扇形部分
    /// </summary>
    void TriangulateEdgeFan(Vector3 center, EdgeVertices edge, float type, float index)
    {
